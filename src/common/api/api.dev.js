module.exports = {
  ...
  wsServiceHost: "http://test-api-eiot.energyiot.cn/service", //后端websocket接口地址
  wsManageHost: "http://test-api-manage.energyiot.cn/manage", //后端websocket接口地址
  ...
  manageConfigur: "https://test-m.energyiot.cn/nav/configur",
  debug: false
};
