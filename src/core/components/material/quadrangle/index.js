...
import "../../../../assets/less/components/component/material/quadrangle.less";
// 四边形
class Display extends Component {
  ...
  template() {
    ...
    return super.wrap(
      { info },
      `
    <div class="bm-material-quadrangle-com component"
  ...
  renderSvgContent() {
    let { info = {} } = this;
    let { width = 0, height = 0, borderWidth = 0, borderRadius = 0 } =
      info || {};
    return `<rect
      x="${borderWidth}"
      y="${borderWidth}"
  ...
  refresh() {
    super.refresh();
    let { info = {} } = this;
    let { id = "", width = 0, height = 0, borderWidth = 0, borderRadius = 0 } =
      info || {};
