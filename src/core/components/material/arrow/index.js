...
import "../../../../assets/less/components/component/material/arrow.less";
const points = [
  [84, 17.5],
  [53.3, 28.5],
  [59.6, 34.8],
...
class Display extends Component {
  ...
  template() {
    ...
    return super.wrap(
      { info },
      `
    <div class="bm-material-arrow-com component"
  ...
  renderSvg() {
    ...
    return ` <svg
    version="1.1"
    viewBox="${17.5 - borderWidth} ${17.5 - borderWidth} ${width} ${height}"
  width="${width}"
  height="${height}"
