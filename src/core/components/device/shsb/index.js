...
class Display extends Component {
  ...
  template() {
    ...
    return super.wrap(
      { info },
      `
    <div class="bm-device-shsb-com component"
...
>
  <defs>
    <style type='text/css'>
    .shsb-${id}-st0{fill:#0E1F3D;}
            .shsb-${id}-st1{fill:#203972;}
            .shsb-${id}-st2{fill:url(#Shsb_1_);}
            .shsb-${id}-st3{fill:url(#Shsb_2_);}
            .shsb-${id}-st4{opacity:0.8;fill:#FFFFFF;enable-background:new    ;}
            .shsb-${id}-st5{fill:url(#Shsb_3_);}
            .shsb-${id}-st6{fill:url(#Shsb_4_);}
            .shsb-${id}-st7{fill:url(#Shsb_5_);}
            .shsb-${id}-st8{fill:url(#Shsb_6_);}
            .shsb-${id}-st9{fill:url(#Shsb_7_);}
            .shsb-${id}-st10{fill:url(#Shsb_8_);}
            .shsb-${id}-st11{fill:url(#Shsb_9_);}
            .shsb-${id}-st12{fill:#2C6977;}
            .shsb-${id}-st13{fill:url(#Shsb_10_);}
            .shsb-${id}-st14{fill:url(#Shsb_11_);}
            .shsb-${id}-st15{fill:#0A3055;}
            .shsb-${id}-st16{fill:url(#Shsb_12_);}
            .shsb-${id}-st17{fill:url(#Shsb_13_);}
            .shsb-${id}-st18{fill:#8CC9EA;}
            .shsb-${id}-st19{fill:url(#Shsb_14_);}
            .shsb-${id}-st20{fill:url(#Shsb_15_);}
            .shsb-${id}-st21{fill:url(#Shsb_16_);}
            .shsb-${id}-st22{fill:url(#Shsb_17_);}
            .shsb-${id}-st23{fill:url(#Shsb_18_);}
            .shsb-${id}-st24{fill:url(#Shsb_19_);}
            .shsb-${id}-st25{fill:url(#Shsb_20_);}
            .shsb-${id}-st26{fill:url(#Shsb_21_);}
            .shsb-${id}-st27{fill:url(#Shsb_22_);}
            .shsb-${id}-st28{fill:url(#Shsb_23_);}
            .shsb-${id}-st29{fill:url(#Shsb_24_);}
            .shsb-${id}-st30{fill:url(#Shsb_25_);}
            .shsb-${id}-st31{fill:url(#Shsb_26_);}
            .shsb-${id}-st32{fill:url(#Shsb_27_);}
            .shsb-${id}-st33{fill:#489ACC;}
            .shsb-${id}-st34{fill:url(#Shsb_28_);}
            .shsb-${id}-st35{fill:#7BB8D6;}
            .shsb-${id}-st36{fill:url(#Shsb_29_);}
            .shsb-${id}-st37{opacity:0.5;}
            .shsb-${id}-st38{fill:#FFFFFF;}
            .shsb-${id}-st39{fill:url(#Shsb_30_);}
            .shsb-${id}-st40{fill:url(#Shsb_31_);}
            .shsb-${id}-st41{opacity:0.6;fill:#FF0000;}
  </style></defs>
  ...
  <g id="SVG_base">
    ...
    <radialGradient
      ...
      cy="84.3027"
      r="30.4579"
      gradientTransform="matrix(1 0 0 1.6113 0 -51.5343)"
      gradientUnits="userSpaceOnUse"
    >
    ...
    <radialGradient
      ...
      cy="85.1681"
      r="39.834"
      gradientTransform="matrix(1 0 0 1.575 0 -46.7284)"
      gradientUnits="userSpaceOnUse"
    >
    ...
    >
      ...
      <stop
        offset="0.1794"
        style="stop-color:#193562;stop-opacity:0.6472"
      />
      <stop
        offset="0.3682"
        style="stop-color:#234173;stop-opacity:0.2756"
      />
      <stop offset="0.5084" style="stop-color:#274579;stop-opacity:0" />
      <stop offset="0.644" style="stop-color:#244174;stop-opacity:0.2759" />
      <stop
        offset="0.8143"
        style="stop-color:#1B3764;stop-opacity:0.6223"
      />
    ...
    <linearGradient
      ...
      x2="-29.501"
      y2="-249.316"
      gradientTransform="matrix(0 1 -1 0 -49.3837 130.6543)"
    >
      <stop offset="2.793296e-03" style="stop-color:#234173" />
      <stop offset="0.1536" style="stop-color:#356BAC" />
      <stop offset="0.3017" style="stop-color:#6BAACD" />
