...
class Text extends Component {
  ...
  template() {
    ...
    return super.wrap(
      { info },
      `
    <div class="bm-device-pfj-com component"
  ...
  >
    ...
    .pfj-${id}-st0{fill:#4065A8;}
        .pfj-${id}-st1{fill:url(#pfj_1_);}
        .pfj-${id}-st2{fill:url(#pfj_2_);}
        .pfj-${id}-st3{fill:#FF1C1C;}
        .pfj-${id}-st4{fill:url(#pfj_3_);}
        .pfj-${id}-st5{fill:url(#pfj_4_);}
        .pfj-${id}-st6{fill:url(#pfj_5_);}
        .pfj-${id}-st7{fill:url(#pfj_6_);}
        .pfj-${id}-st8{fill:url(#pfj_7_);}
        .pfj-${id}-st9{opacity:0.3;}
        .pfj-${id}-st10{fill:#303435;}
        .pfj-${id}-st11{fill:#BCC5CC;}
        .pfj-${id}-st12{fill:url(#pfj_8_);}
        .pfj-${id}-st13{fill:url(#pfj_9_);}
        .pfj-${id}-st14{fill:#283460;}
        .pfj-${id}-st15{fill:#9BBAE8;}
        .pfj-${id}-st16{fill:url(#pfj_10_);}
        .pfj-${id}-st17{opacity:0.15;fill:url(#pfj_11_);}
        .pfj-${id}-st18{opacity:0.2;fill:url(#pfj_12_);}
        .pfj-${id}-st19{fill:url(#pfj_13_);}
        .pfj-${id}-st20{fill:url(#pfj_14_);}
        .pfj-${id}-st21{fill:url(#pfj_15_);}
        .pfj-${id}-st22{opacity:0.8;fill:url(#pfj_16_);}
        .pfj-${id}-st23{opacity:0.8;fill:url(#pfj_17_);}
        .pfj-${id}-st24{opacity:0.8;fill:url(#pfj_18_);}
        .pfj-${id}-st25{opacity:0.8;fill:url(#pfj_19_);}
        .pfj-${id}-st26{opacity:0.8;fill:url(#pfj_20_);}
        .pfj-${id}-st27{opacity:0.8;fill:url(#pfj_21_);}
        .pfj-${id}-st28{opacity:0.8;fill:url(#pfj_22_);}
        .pfj-${id}-st29{opacity:0.8;fill:url(#pfj_23_);}
        .pfj-${id}-st30{fill:url(#pfj_24_);}
        .pfj-${id}-st31{fill:url(#pfj_25_);}
        .pfj-${id}-st32{fill:#88B9FE;}
        .pfj-${id}-st33{fill:#3C6DD6;}
        .pfj-${id}-st34{opacity:0.6;fill:#FF1C1C;}
  ...
  <g class="SVG_sta" >
    ...
    <circle
      ...
      r="24.29"
    />
    <circle class="pfj-${id}-st3" cx="125.65" cy="68.6" r="1.33" />
    <circle class="pfj-${id}-st3" cx="140.98" cy="95.16" r="1.33" />
    <circle class="pfj-${id}-st3" cx="118.5" cy="77.91" r="1.33" />
    <circle class="pfj-${id}-st3" cx="148.13" cy="85.85" r="1.33" />
    <circle class="pfj-${id}-st3" cx="146.59" cy="74.21" r="1.33" />
    <circle class="pfj-${id}-st3" cx="120.03" cy="89.55" r="1.33" />
    <circle class="pfj-${id}-st3" cx="137.28" cy="67.07" r="1.33" />
    <circle class="pfj-${id}-st3" cx="129.35" cy="96.69" r="1.33" />
  </g>
  <g id="SVG_base2">
    <linearGradient
      id="pfj_6_"
    ...
    />
    <circle class="pfj-${id}-st10" cx="134.31" cy="81" r="4.03" />
    <circle
      class="pfj-${id}-st11"
      cx="133.31"
      cy="81.99"
    ...
    <circle class="pfj-${id}-st24" cx="67.98" cy="96.36" r="1.46" />
    <linearGradient
      id="pfj_19_"
      gradientUnits="userSpaceOnUse"
      x1="164.1222"
    ...
    <circle class="pfj-${id}-st26" cx="78.89" cy="64.51" r="1.46" />
    <linearGradient
      id="pfj_21_"
      gradientUnits="userSpaceOnUse"
      x1="151.6115"
