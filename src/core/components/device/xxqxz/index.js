...
class Display extends Component {
  ...
  template() {
    ...
    return super.wrap(
      { info },
      `
    <div class="bm-device-xxqxz-com component"
  ...
  renderSvg() {
    ...
    <defs>
    <style type='text/css'>
      .xxqxz-${id}-st0{fill:url(#xxqxz_2_);}
      .xxqxz-${id}-st1{fill:#C2C8CE;}
      .xxqxz-${id}-st2{fill:#A5AEB5;}
      .xxqxz-${id}-st3{fill:#DFE3E8;}
      .xxqxz-${id}-st4{fill:url(#xxqxz_3_);}
      .xxqxz-${id}-st5{fill:url(#xxqxz_4_);}
      .xxqxz-${id}-st6{fill:#AEB4BA;}
      .xxqxz-${id}-st7{fill:url(#xxqxz_5_);}
      .xxqxz-${id}-st8{fill:url(#xxqxz_6_);}
      .xxqxz-${id}-st9{fill:url(#xxqxz_7_);}
      .xxqxz-${id}-st10{fill:url(#xxqxz_8_);}
      .xxqxz-${id}-st11{fill:#222528;}
      .xxqxz-${id}-st12{fill:url(#xxqxz_9_);}
      .xxqxz-${id}-st13{fill:#161819;}
      .xxqxz-${id}-st14{fill:url(#xxqxz_10_);}
      .xxqxz-${id}-st15{fill:url(#xxqxz_11_);}
      .xxqxz-${id}-st16{fill:url(#xxqxz_12_);}
      .xxqxz-${id}-st17{fill:url(#xxqxz_13_);}
      .xxqxz-${id}-st18{fill:url(#xxqxz_14_);}
      .xxqxz-${id}-st19{fill:url(#xxqxz_15_);}
      .xxqxz-${id}-st20{fill:url(#xxqxz_16_);}
      .xxqxz-${id}-st21{fill:url(#xxqxz_17_);}
      .xxqxz-${id}-st22{fill:url(#xxqxz_18_);}
      .xxqxz-${id}-st23{fill:url(#xxqxz_19_);}
      .xxqxz-${id}-st24{opacity:0.21;}
      .xxqxz-${id}-st25{fill:url(#xxqxz_20_);}
      .xxqxz-${id}-st26{fill:url(#xxqxz_21_);}
      .xxqxz-${id}-st27{fill:url(#xxqxz_22_);}
      .xxqxz-${id}-st28{fill:#EAEEF0;}
      .xxqxz-${id}-st29{fill:url(#xxqxz_23_);}
      .xxqxz-${id}-st30{fill:url(#xxqxz_24_);}
      .xxqxz-${id}-st31{fill:url(#xxqxz_25_);}
      .xxqxz-${id}-st32{opacity:0.2;fill:#FFFFFF;}
  </style>
  </defs>
