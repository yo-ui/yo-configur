	...
	template(){
		return $(`<div id="${this.id}" class="configur-spirit" style="position:absolute;left:${this.x}px;top: ${this.y}px;z-index: ${this.zIndex};transform: rotate(${this.rotate}deg)">
		  <svg class="canvas" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="${this.width}" height="${this.height}"
					 viewBox="0 0 74 58" xml:space="preserve" preserveAspectRatio="none">
				<style type="text/css">
				...
				<linearGradient id="sxta_2_" gradientUnits="userSpaceOnUse" x1="38.8737" y1="52.9954" x2="44.8327" y2="52.9954">
				...
				<linearGradient id="sxta_3_" gradientUnits="userSpaceOnUse" x1="37.0088" y1="48.5027" x2="70.2418" y2="48.5027">
				...
				<linearGradient id="sxta_4_" gradientUnits="userSpaceOnUse" x1="37.2257" y1="40.5697" x2="46.4807" y2="40.5697">
					<stop  offset="0" style="stop-color:#83878E"/>
					<stop  offset="0.4813" style="stop-color:#D9DDE2"/>
					<stop  offset="1" style="stop-color:#83878E"/>
				</linearGradient>
				...
				<linearGradient id="sxta_5_" gradientUnits="userSpaceOnUse" x1="34.5197" y1="22.7717" x2="46.7543" y2="38.2562">
					<stop  offset="0" style="stop-color:#BCC6C9"/>
				...
				<path id="sxta_1480_" class="sxta-st8" d="M53.1,9.8C48,3.4,40.4,1,36.2,4.4l-27,22.8l20.4,23.6l25.2-23.2C59,24.1,58.3,16.2,53.1,9.8z"
					/>
				<ellipse id="sxta_1475_" transform="matrix(0.756 -0.6546 0.6546 0.756 -20.7934 22.1779)" class="sxta-st2" cx="19.4" cy="39" rx="10.3" ry="15.6"/>
				<linearGradient id="sxta_6_" gradientUnits="userSpaceOnUse" x1="29.2541" y1="43.1684" x2="15.4902" y2="37.6245">
				...
				<path id="sxta_1477_" class="sxta-st9" d="M25.5,33.8c5,5.7,6.2,12.8,2.8,15.8s-10.2,0.7-15.2-5.1s-6.2-12.8-2.8-15.8S20.5,28,25.5,33.8
					z"/>
				<radialGradient id="sxta_7_" cx="16.4063" cy="38.7661" r="6.3265" gradientTransform="matrix(1 0 0 1.5352 0 -20.7473)" gradientUnits="userSpaceOnUse">
				...
				<linearGradient id="sxta_8_" gradientUnits="userSpaceOnUse" x1="7.9096" y1="32.4517" x2="29.3202" y2="45.0687">
				...
				<path id="sxta_1482_" class="sxta-st11" d="M25.5,33.8c5,5.7,6.2,12.8,2.8,15.8s-10.2,0.7-15.2-5.1s-6.2-12.8-2.8-15.8
					S20.5,28,25.5,33.8z"/>
				<linearGradient id="sxta_9_" gradientUnits="userSpaceOnUse" x1="-2.728484e-012" y1="30.1501" x2="33.861" y2="30.1501">
				...
				<linearGradient id="sxta_10_" gradientUnits="userSpaceOnUse" x1="24.3426" y1="9.5488" x2="39.8299" y2="29.0751">
