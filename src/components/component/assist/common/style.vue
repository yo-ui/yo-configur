<template>
  <div class="bm-assist-common-style-com">
    <!-- <h2>{{ $lang("功能选择") }}</h2>
    <p>
      <i
        class="el-icon-rank"
    ...
    <template v-if="info.backgroundImage">
      ...
      <p>
        ...
        >
          <el-option
            v-for="item in assistCommonFormList"
            :key="item.code"
            :label="$lang(item.name)"
            :value="item.code"
          >
