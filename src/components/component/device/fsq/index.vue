    ...
    >
      <defs
        v-html="
          `
        <style type='text/css'>
       .fsq-${info.id}-st0{fill:url(#fsq_1_);}
                .fsq-${info.id}-st1{fill:url(#fsq_2_);}
                .fsq-${info.id}-st2{fill:url(#fsq_3_);}
                .fsq-${info.id}-st3{fill:url(#fsq_4_);}
                .fsq-${info.id}-st4{fill:url(#fsq_5_);}
                .fsq-${info.id}-st5{fill:#3F9CFF;}
                .fsq-${info.id}-st6{fill:url(#fsq_6_);}
                .fsq-${info.id}-st7{fill:url(#fsq_7_);}
                .fsq-${info.id}-st8{fill:url(#fsq_8_);}
                .fsq-${info.id}-st9{fill:url(#fsq_9_);}
                .fsq-${info.id}-st10{fill:url(#fsq_10_);}
                .fsq-${info.id}-st11{fill:url(#fsq_11_);}
                .fsq-${info.id}-st12{fill:url(#fsq_12_);}
                .fsq-${info.id}-st13{fill:url(#fsq_13_);}
                .fsq-${info.id}-st14{fill:url(#fsq_14_);}
                .fsq-${info.id}-st15{fill:url(#fsq_15_);}
                .fsq-${info.id}-st16{fill:url(#fsq_16_);}
                .fsq-${info.id}-st17{fill:url(#fsq_17_);}
                .fsq-${info.id}-st18{fill:url(#fsq_18_);}
                .fsq-${info.id}-st19{fill:url(#fsq_19_);}
                .fsq-${info.id}-st20{fill:url(#fsq_20_);}
                .fsq-${info.id}-st21{fill:url(#fsq_21_);}
                .fsq-${info.id}-st22{fill:url(#fsq_22_);}
                .fsq-${info.id}-st23{fill:url(#fsq_23_);}
                .fsq-${info.id}-st24{fill:url(#fsq_24_);}
                .fsq-${info.id}-st25{fill:url(#fsq_25_);}
                .fsq-${info.id}-st26{fill:url(#fsq_26_);}
                .fsq-${info.id}-st27{fill:url(#fsq_27_);}
                .fsq-${info.id}-st28{fill:url(#fsq_28_);}
                .fsq-${info.id}-st29{fill:url(#fsq_29_);}
                .fsq-${info.id}-st30{fill:url(#fsq_30_);}
                .fsq-${info.id}-st31{fill:url(#fsq_31_);}
                .fsq-${info.id}-st32{fill:url(#fsq_32_);}
                .fsq-${info.id}-st33{fill:url(#fsq_33_);}
                .fsq-${info.id}-st34{fill:url(#fsq_34_);}
                .fsq-${info.id}-st35{fill:url(#fsq_35_);}
                .fsq-${info.id}-st36{fill:url(#fsq_36_);}
                .fsq-${info.id}-st37{fill:url(#fsq_37_);}
                .fsq-${info.id}-st38{fill:url(#fsq_38_);}
                .fsq-${info.id}-st39{opacity:0.4;}
                .fsq-${info.id}-st40{fill:#FFFFFF;}
                .fsq-${info.id}-st41{fill:#5F6675;}
                .fsq-${info.id}-st42{fill:#014C90;}
      </style>
      `
        "
      ></defs>
      ...
      />
      <g :class="`fsq-${info.id}-st39`">
        <path
          :class="`fsq-${info.id}-st40`"
