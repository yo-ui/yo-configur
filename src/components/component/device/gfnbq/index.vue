// 光伏逆变器
<template>
  <div class="bm-device-gfnbq-com" :style="comStyle">
    <svg
      version="1.1"
    ...
    >
      <defs
        v-html="
          `
        <style type='text/css'>
					.gfnbq-${info.id}-st0{fill:#DFE2E8;}
					.gfnbq-${info.id}-st1{fill:#C1C7CC;}
					.gfnbq-${info.id}-st2{opacity:0.2;fill:#231815;}
					.gfnbq-${info.id}-st3{fill:#FFFFFF;}
					.gfnbq-${info.id}-st4{fill:#838776;}
					.gfnbq-${info.id}-st5{fill:#25282B;}
					.gfnbq-${info.id}-st6{fill:#1B5C30;}
					.gfnbq-${info.id}-st7{fill:#48A554;}
					.gfnbq-${info.id}-st8{fill:#831A1F;}
					.gfnbq-${info.id}-st9{fill:#D04A48;}
					.gfnbq-${info.id}-st10{fill:#9F4A23;}
					.gfnbq-${info.id}-st11{fill:#EF8124;}
					.gfnbq-${info.id}-st12{opacity:0.8;}
					.gfnbq-${info.id}-st13{fill:#F4D321;}
					.gfnbq-${info.id}-st14{fill:#231815;}
					.gfnbq-${info.id}-st15{fill:#040000;}
					.gfnbq-${info.id}-st16{opacity:0.5;}
					.gfnbq-${info.id}-st17{fill:#454444;}
					.gfnbq-${info.id}-st18{fill:#666767;}
      </style>
      `
        "
      ></defs>
      <rect
        ...
        x="0.5"
        y="17.2"
        :class="`gfnbq-${info.id}-st0`"
        width="138.9"
        height="136.2"
      />
      <polygon
        id="gfnbq_535_"
        :class="`gfnbq-${info.id}-st1`"
      ...
      <g id="gfnbq_620_">
        <rect
          ...
          x="12.9"
          y="40.7"
          :class="`gfnbq-${info.id}-st4`"
          width="45"
          height="20.9"
        />
        <path
          id="gfnbq_621_"
          :class="`gfnbq-${info.id}-st5`"
          d="M58.9,62.6h-47V39.7h47V62.6z M13.9,60.6h43V41.7h-43V60.6z"
        />
      </g>
      <circle
        id="gfnbq_619_"
        :class="`gfnbq-${info.id}-st6`"
        cx="15.9"
        cy="32.9"
        r="2"
      />
      ...
      <g id="gfnbq_575_" :class="`gfnbq-${info.id}-st16`">
        <polygon
          id="gfnbq_567_"
          :class="`gfnbq-${info.id}-st15`"
      ...
      <g id="gfnbq_576_" :class="`gfnbq-${info.id}-st16`">
        <polygon
          id="gfnbq_594_"
          :class="`gfnbq-${info.id}-st15`"
      ...
      <g id="gfnbq_595_" :class="`gfnbq-${info.id}-st16`">
        <polygon
          id="gfnbq_608_"
          :class="`gfnbq-${info.id}-st15`"
