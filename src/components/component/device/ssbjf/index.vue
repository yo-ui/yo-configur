// 湿式报警阀
<template>
  <div class="bm-device-ssbjf-com" :style="comStyle">
    <svg
      version="1.1"
    ...
    >
      <defs
        v-html="
          `<style type='text/css'>
              .ssbjf-${info.id}-st0{fill:url(#ssbjf_1_);}
              .ssbjf-${info.id}-st1{fill:url(#ssbjf_2_);}
              .ssbjf-${info.id}-st2{fill:#FFB6BB;}
              .ssbjf-${info.id}-st3{fill:url(#ssbjf_3_);}
              .ssbjf-${info.id}-st4{fill:url(#ssbjf_4_);}
              .ssbjf-${info.id}-st5{fill:url(#ssbjf_5_);}
              .ssbjf-${info.id}-st6{fill:url(#ssbjf_6_);}
              .ssbjf-${info.id}-st7{fill:url(#ssbjf_7_);}
              .ssbjf-${info.id}-st8{fill:url(#ssbjf_8_);}
              .ssbjf-${info.id}-st9{fill:url(#ssbjf_9_);}
              .ssbjf-${info.id}-st10{fill:#5C5C5C;}
              .ssbjf-${info.id}-st11{fill:url(#ssbjf_10_);}
              .ssbjf-${info.id}-st12{fill:#B71C27;}
              .ssbjf-${info.id}-st13{fill:url(#ssbjf_11_);}
              .ssbjf-${info.id}-st14{fill:url(#ssbjf_12_);}
              .ssbjf-${info.id}-st15{fill:url(#ssbjf_13_);}
              .ssbjf-${info.id}-st16{fill:url(#ssbjf_14_);}
              .ssbjf-${info.id}-st17{fill:url(#ssbjf_15_);}
              .ssbjf-${info.id}-st18{fill:url(#ssbjf_16_);}
              .ssbjf-${info.id}-st19{fill:url(#ssbjf_17_);}
              .ssbjf-${info.id}-st20{fill:url(#ssbjf_18_);}
              .ssbjf-${info.id}-st21{fill:url(#ssbjf_19_);}
              .ssbjf-${info.id}-st22{fill:#2F3338;}
              .ssbjf-${info.id}-st23{fill:#FFFFFF;}
              .ssbjf-${info.id}-st24{fill:url(#ssbjf_20_);}
              .ssbjf-${info.id}-st25{fill:url(#ssbjf_21_);}
              .ssbjf-${info.id}-st26{fill:url(#ssbjf_22_);}
              .ssbjf-${info.id}-st27{fill:url(#ssbjf_23_);}
              .ssbjf-${info.id}-st28{fill:url(#ssbjf_24_);}
              .ssbjf-${info.id}-st29{fill:url(#ssbjf_25_);}
              .ssbjf-${info.id}-st30{fill:url(#ssbjf_26_);}
              .ssbjf-${info.id}-st31{fill:url(#ssbjf_27_);}
              .ssbjf-${info.id}-st32{fill:url(#ssbjf_28_);}
              .ssbjf-${info.id}-st33{fill:url(#ssbjf_29_);}
              .ssbjf-${info.id}-st34{fill:url(#ssbjf_30_);}
              .ssbjf-${info.id}-st35{fill:url(#ssbjf_31_);}
              .ssbjf-${info.id}-st36{fill:url(#ssbjf_32_);}
              .ssbjf-${info.id}-st37{fill:url(#ssbjf_33_);}
      ...
      <g id="SVG_base">
        ...
        <g>
          ...
          <circle
            :class="`ssbjf-${info.id}-st9`"
            cx="229.14"
            cy="104.14"
            r="10.86"
          />
          <circle
            :class="`ssbjf-${info.id}-st10`"
            cx="229.14"
            cy="107"
            r="10.86"
          />
          ...
          <circle
            :class="`ssbjf-${info.id}-st11`"
            cx="229.14"
            cy="107"
            r="8.84"
          />
          <polygon
            :class="`ssbjf-${info.id}-st12`"
        ...
        <rect
          x="143.89"
          y="89.26"
          :class="`ssbjf-${info.id}-st21`"
          width="65.04"
          height="29.84"
        />
        <g>
          <path
            :class="`ssbjf-${info.id}-st22`"
    ...
    init() {
      ...
      if (showType != "edit") {
        ...
        $vm.$on(`devicePointEvent_${id}`, ({ device }) => {
          bmCommon.log("deviceSsbjfCom", device);
