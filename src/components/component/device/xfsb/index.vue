      ...
      <g class="SVG_ani" v-if="pointValue == 1">
        <g class="f1">
          ...
          <g :class="`xfsb-${info.id}-st29`">
            ...
            />
            <g :class="`xfsb-${info.id}-st34`">
              <path
                :class="`xfsb-${info.id}-st35`"
