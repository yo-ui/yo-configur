// 立式空调
<template>
  <div class="bm-device-lskt-com" :style="comStyle">
    <svg
      version="1.1"
    ...
    >
      <defs
        v-html="
          `
        <style type='text/css'>
					.lskt-${info.id}-st0{fill:#D0D4D8;}
					.lskt-${info.id}-st1{fill:url(#lskt_2_);}
					.lskt-${info.id}-st2{fill:#AFB7BC;}
					.lskt-${info.id}-st3{fill:url(#lskt_3_);}
					.lskt-${info.id}-st4{fill:url(#lskt_4_);}
					.lskt-${info.id}-st5{fill:url(#lskt_5_);}
					.lskt-${info.id}-st6{fill:url(#lskt_6_);}
					.lskt-${info.id}-st7{fill:url(#lskt_7_);}
					.lskt-${info.id}-st8{fill:none;stroke:#D0D4D8;stroke-width:0.75;stroke-miterlimit:10;}
      </style>
      `
        "
      ></defs>
