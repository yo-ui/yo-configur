//储液储气罐
<template>
  <div class="bm-device-cycqg-com" :style="comStyle">
    <svg
      version="1.1"
    ...
    >
      <defs
        v-html="
          `
        <style type='text/css'>
	.cycqg-${info.id}-st0{fill:url(#cycqg_${info.id}_SVGID_1_);}
	.cycqg-${info.id}-st1{fill:url(#cycqg_${info.id}_SVGID_2_);}
	.cycqg-${info.id}-st2{fill:url(#cycqg_${info.id}_SVGID_3_);}
      </style>
      `
        "
      ></defs>
