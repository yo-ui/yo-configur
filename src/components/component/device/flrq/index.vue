// 风冷热器 风冷热泵机组
<template>
  <div class="bm-device-flrq-com" :style="comStyle">
    <svg
      version="1.1"
    ...
    >
      <defs
        v-html="
          ...
          .flrb-${info.id}-st0{fill:#191919;}
          .flrb-${info.id}-st1{fill:url(#flrb_1_);}
          .flrb-${info.id}-st2{fill:url(#flrb_2_);}
          .flrb-${info.id}-st3{fill:url(#flrb_3_);}
          .flrb-${info.id}-st4{fill:url(#flrb_4_);}
          .flrb-${info.id}-st5{fill:url(#flrb_5_);}
          .flrb-${info.id}-st6{fill:url(#flrb_6_);}
          .flrb-${info.id}-st7{fill:url(#flrb_7_);}
          .flrb-${info.id}-st8{fill:url(#flrb_8_);}
          .flrb-${info.id}-st9{fill:url(#flrb_9_);}
          .flrb-${info.id}-st10{fill:#BC4B59;}
          .flrb-${info.id}-st11{fill:url(#flrb_10_);}
          .flrb-${info.id}-st12{fill:url(#flrb_11_);}
          .flrb-${info.id}-st13{fill:url(#flrb_12_);}
          .flrb-${info.id}-st14{opacity:0.4;fill:#FFFFFF;}
          .flrb-${info.id}-st15{opacity:0.3;}
          .flrb-${info.id}-st16{fill:url(#flrb_13_);}
          .flrb-${info.id}-st17{fill:url(#flrb_14_);}
          .flrb-${info.id}-st18{fill:#FFFFFF;}
          .flrb-${info.id}-st19{fill:#585F60;}
          .flrb-${info.id}-st20{fill:#FCFCFC;}
          .flrb-${info.id}-st21{fill:url(#flrb_15_);}
          .flrb-${info.id}-st22{fill:url(#flrb_16_);}
          .flrb-${info.id}-st23{fill:url(#flrb_17_);}
          .flrb-${info.id}-st24{fill:url(#flrb_18_);}
          .flrb-${info.id}-st25{fill:url(#flrb_19_);}
          .flrb-${info.id}-st26{fill:url(#flrb_20_);}
          .flrb-${info.id}-st27{fill:url(#flrb_21_);}
          .flrb-${info.id}-st28{fill:#707070;}
          .flrb-${info.id}-st29{fill:url(#flrb_22_);}
          .flrb-${info.id}-st30{fill:url(#flrb_23_);}
          .flrb-${info.id}-st31{fill:url(#flrb_24_);}
          .flrb-${info.id}-st32{fill:#181D1E;}
          .flrb-${info.id}-st33{fill:url(#flrb_25_);}
          .flrb-${info.id}-st34{fill:url(#flrb_26_);}
          .flrb-${info.id}-st35{fill:url(#flrb_27_);}
          .flrb-${info.id}-st36{fill:url(#flrb_28_);}
          .flrb-${info.id}-st37{fill:url(#flrb_29_);}
          .flrb-${info.id}-st38{fill:url(#flrb_30_);}
          .flrb-${info.id}-st39{fill:url(#flrb_31_);}
          .flrb-${info.id}-st40{fill:url(#flrb_32_);}
          .flrb-${info.id}-st41{fill:url(#flrb_33_);}
          .flrb-${info.id}-st42{fill:url(#flrb_34_);}
          .flrb-${info.id}-st43{fill:url(#flrb_35_);}
          .flrb-${info.id}-st44{fill:url(#flrb_36_);}
          .flrb-${info.id}-st45{fill:url(#flrb_37_);}
          .flrb-${info.id}-st46{fill:url(#flrb_38_);}
          .flrb-${info.id}-st47{fill:url(#flrb_39_);}
          .flrb-${info.id}-st48{fill:url(#flrb_40_);}
          .flrb-${info.id}-st49{fill:url(#flrb_41_);}
          .flrb-${info.id}-st50{fill:url(#flrb_42_);}
          .flrb-${info.id}-st51{fill:url(#flrb_43_);}
          .flrb-${info.id}-st52{fill:url(#flrb_44_);}
          .flrb-${info.id}-st53{fill:url(#flrb_45_);}
          .flrb-${info.id}-st54{fill:#808484;}
          .flrb-${info.id}-st55{fill:url(#flrb_46_);}
          .flrb-${info.id}-st56{fill:url(#flrb_47_);}
          .flrb-${info.id}-st57{fill:url(#flrb_48_);}
          .flrb-${info.id}-st58{fill:none;stroke:#798689;stroke-width:2;stroke-miterlimit:10;}
          .flrb-${info.id}-st59{fill:url(#flrb_49_);}
          .flrb-${info.id}-st60{fill:url(#flrb_50_);}
          .flrb-${info.id}-st61{fill:url(#flrb_51_);}
          .flrb-${info.id}-st62{fill:#3D3F3F;}
          .flrb-${info.id}-st63{fill:url(#flrb_52_);}
          .flrb-${info.id}-st64{fill:url(#flrq_40_);}
          .flrb-${info.id}-st65{fill:#D6D6D6;}
          .flrb-${info.id}-st66{fill:url(#flrq_43_);}
          .flrb-${info.id}-st67{fill:url(#flrq_44_);}
          .flrb-${info.id}-st68{fill:url(#flrq_45_);}
          .flrb-${info.id}-st69{fill:url(#flrq_46_);}
          .flrb-${info.id}-st70{fill:url(#flrq_55_);}
          .flrb-${info.id}-st71{fill:url(#flrq_56_);}
          .flrb-${info.id}-st72{fill:url(#flrq_59_);}
          .flrb-${info.id}-st73{fill:url(#flrq_60_);}
          .flrb-${info.id}-st74{fill:url(#flrq_63_);}
          .flrb-${info.id}-st75{fill:url(#flrq_64_);}
          .flrb-${info.id}-st76{fill:url(#flrq_70_);}
          .flrb-${info.id}-st77{fill:url(#flrq_71_);}
          .flrb-${info.id}-st78{fill:url(#flrq_73_);}
          .flrb-${info.id}-st79{fill:url(#flrq_74_);}
          .flrb-${info.id}-st80{fill:url(#flrq_82_);}
          .flrb-${info.id}-st81{fill:url(#flrq_83_);}
          .flrb-${info.id}-st82{fill:url(#flrq_115_);}
          .flrb-${info.id}-st83{fill:url(#flrq_116_);}
          .flrb-${info.id}-st84{fill:url(#flrq_117_);}
          .flrb-${info.id}-st85{fill:url(#flrq_118_);}
          .flrb-${info.id}-st86{fill:url(#flrq_119_);}
          .flrb-${info.id}-st87{fill:url(#flrq_120_);}
          .flrb-${info.id}-st88{fill:url(#flrq_121_);}
          .flrb-${info.id}-st89{fill:url(#flrq_122_);}
          .flrb-${info.id}-st90{fill:url(#flrq_123_);}
          .flrb-${info.id}-st91{fill:url(#flrq_124_);}
          .flrb-${info.id}-st92{fill:url(#flrq_125_);}
          .flrb-${info.id}-st93{fill:url(#flrq_126_);}
          .flrb-${info.id}-st94{fill:url(#flrq_133_);}
          .flrb-${info.id}-st95{fill:url(#flrq_134_);}
          .flrb-${info.id}-st96{fill:url(#flrq_135_);}
          .flrb-${info.id}-st97{fill:url(#flrq_136_);}
          .flrb-${info.id}-st98{fill:url(#flrq_137_);}
          .flrb-${info.id}-st99{fill:url(#flrq_138_);}
          .flrb-${info.id}-st100{fill:url(#flrq_139_);}
          .flrb-${info.id}-st101{fill:url(#flrq_140_);}
          .flrb-${info.id}-st102{fill:url(#flrq_141_);}
          .flrb-${info.id}-st103{fill:url(#flrq_142_);}
          .flrb-${info.id}-st104{fill:url(#flrq_143_);}
          .flrb-${info.id}-st105{fill:url(#flrq_144_);}
          .flrb-${info.id}-st106{fill:url(#flrq_151_);}
          .flrb-${info.id}-st107{fill:url(#flrq_152_);}
          .flrb-${info.id}-st108{fill:#F2F2F2;}
          .flrb-${info.id}-st109{fill:url(#flrq_153_);}
          .flrb-${info.id}-st110{fill:url(#flrq_154_);}
          .flrb-${info.id}-st111{fill:url(#flrq_155_);}
          .flrb-${info.id}-st112{fill:url(#flrq_156_);}
          .flrb-${info.id}-st113{fill:url(#flrq_157_);}
          .flrb-${info.id}-st114{opacity:0.4;fill:#FF0303;}
      </style>`
        "
      ></defs>
      <g id="SVG_base1">
        <polygon
          :class="`flrb-${info.id}-st0`"
        ...
        <rect
          x="227.8"
          y="102.66"
          :class="`flrb-${info.id}-st57`"
          width="1.97"
          height="107.12"
        />
        <line
          :class="`flrb-${info.id}-st58`"
          x1="318.26"
          y1="98.71"
          x2="388.91"
          y2="139.18"
    ...
    init() {
      ...
      if (showType != "edit") {
        ...
        $vm.$on(`devicePointEvent_${id}`, ({ device }) => {
          bmCommon.log("deviceFlrqCom", device);
