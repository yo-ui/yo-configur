// 水管（右下）
<template>
  <div class="bm-device-sg-right-bottom-com" :style="comStyle">
    <svg
      version="1.1"
    ...
    >
      ...
      <g>
        <radialGradient
          id="sg_right_bottom_LR_"
          cx="296.8083"
          cy="-271.2963"
          r="7.9785"
          gradientTransform="matrix(4.489659e-011 1 -1 4.489659e-011 -271.3311 -296.7776)"
        ...
        <path
          id="sg_right_bottom_536_"
          style="fill:url(#sg_right_bottom_LR_)"
          d="M8,0L1.8,0c0,1.1-0.8,1.8-1.8,1.8L0,8C4.4,8,8,4.4,8,0z"
        />
      </g>
    </svg>
  </div>
