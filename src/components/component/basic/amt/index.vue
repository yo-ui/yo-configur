    ...
    >
      <defs
        v-html="
          `
        <style type='text/css'>
        .amt-st0{fill:url(#amt_${info.id}_SVGID_1_);}
	.amt-st1{fill:url(#amt_${info.id}_SVGID_2_);}
	.amt-st2{opacity:0.6;}
	.amt-st3{fill:#FFFFFF;}
	.amt-st4{display:none;}
	.amt-st5{display:inline;fill:url(#amt_${info.id}_SVGID_3_);}
	.amt-st6{display:inline;fill:url(#amt_${info.id}_SVGID_4_);}
	.amt-st7{display:inline;}
	.amt-st8{fill:#666666;}
      </style>
      `
        "
