<template>
  <div class="bm-display-style-com">
    ...
    <p>
      ...
      <!--  <el-collapse-item :title="$lang('外观')" name="outward">
       <p>
        ...
        </p><template v-if="info.borderStyle != 'none'">
          <p>
            <span class="label"> {{ $lang("边框大小") }}:</span>
            <el-input-number
              controls-position="right"
            ...
            <span>
              ...
              <template v-slot:content>
                <el-button type="primary" size="default" @click="()=>{
                  ...
                  info.borderRadiusBottomRight=info.borderRadiusTopRight;
            ...
            <span>
              ...
              <template v-slot:content>
                <el-button type="primary" size="default" @click="()=>{
                  ...
                  info.borderRadiusTopRight=info.borderRadiusBottomRight;
                  info.borderRadiusBottomRight=info.borderRadiusBottomRight;
                  info.borderRadiusBottomLeft=info.borderRadiusBottomRight;
                }">{{$lang('统一设置')}}</el-button>
                </template><el-input-number
                controls-position="right"
                clearable
            ...
            <span>
              ...
              <template v-slot:content>
                <el-button type="primary" size="default" @click="()=>{
                  ...
                  info.borderRadiusBottomRight=info.borderRadiusBottomLeft;
                  info.borderRadiusBottomLeft=info.borderRadiusBottomLeft;
                }">{{$lang('统一设置')}}</el-button>
                </template><el-input-number
                controls-position="right"
                clearable
